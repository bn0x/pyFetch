...
def draw(options, args):
    ...
    line(ascii)
    if options.free:
        fmtDisk = "%sDisk:    %s%s free %s/%s %s total" % (Fore.WHITE, Fore.YELLOW, pyFetch.format.sizeof_fmt(disk['free']), Fore.WHITE, Fore.CYAN, pyFetch.format.sizeof_fmt(disk['total']))
        fmtRAM  = "%sRAM:     %s%s free %s/%s %s total" % (Fore.WHITE, Fore.YELLOW, pyFetch.format.sizeof_fmt(ram['free']), Fore.WHITE, Fore.CYAN, pyFetch.format.sizeof_fmt(ram['total']))
    else:
        fmtDisk = "%sDisk:    %s%s used %s/%s %s total" % (Fore.WHITE, Fore.YELLOW, pyFetch.format.sizeof_fmt(disk['used']), Fore.WHITE, Fore.CYAN, pyFetch.format.sizeof_fmt(disk['total']))
        fmtRAM  = "%sRAM:     %s%s used %s/%s %s total" % (Fore.WHITE, Fore.YELLOW, pyFetch.format.sizeof_fmt(ram['used']), Fore.WHITE, Fore.CYAN, pyFetch.format.sizeof_fmt(ram['total']))
